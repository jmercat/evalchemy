        ...
        **kwargs,
        ...
        if "gemini" in self.model_name and "thinking" in self.model_name:
            ...
            if "thinking" in self.model_name:
                self.gen_kwargs["thinking"] = {"type": "enabled", "budget_tokens": max_length - 1024}
                self.model_name = (
    ...
    def _create_payload(
        ...
        **kwargs,
        ...
        if "claude" in self.model_name:
            gen_kwargs.pop("max_completion_tokens")
            gen_kwargs.pop("stop")
            gen_kwargs["max_tokens"] = max_tokens
            if "thinking" in self.gen_kwargs:
                gen_kwargs["thinking"] = self.gen_kwargs["thinking"]
                gen_kwargs["thinking"]["budget_tokens"] = max_tokens - 1024
