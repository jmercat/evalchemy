...
def get_image(user, profile="default", region="us-east-1"):
    ...
    # set current directory to the git directory
...
def main():
    ...
    parser.add_argument("--config", default="configs/light_gpt4omini0718.yaml", help="check ./configs in evalchemy")
...
def main_after_setup_move(args):
    ...
    if args.use_queue:
        ...
        queue = Queue(queue_name=QUEUE_MAPPER[args.region][INSTANCE_MAPPER[args.instance_type]])
